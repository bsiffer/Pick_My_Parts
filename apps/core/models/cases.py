...
class ComputerCase(Part):
    ...
    def __init__(
        self, manufacturer, name, sku, price, form_factor, color, supported_form_factors
    ):
        """Initializes a ComputerCase instance."""
        super().__init__(manufacturer, name, sku, price)
        self.__form_factor = form_factor
        self.__color = color
        self.__supported_form_factors = (
            supported_form_factors  # List of supported motherboard form factors
        )
